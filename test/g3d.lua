...
function state:init()
    ...
    sphere:setTranslation(0, 10 ,0)
    cylinder:setTranslation(0, -10, 0)
    plane:setTranslation(0, 0, -5)
end
...
function state:draw()
    ...
    box:draw(uv_shader)
    sphere:draw(uv_shader)
    cylinder:draw(uv_shader)
    plane:draw(uv_shader)
    love.graphics.setMeshCullMode("front")
    skybox:draw(normal_shader)
